...
const LAYOUT = [
  { span: 'md:col-span-7', start: 'md:col-start-1', offset: '', pad: 'p-6 sm:p-9', num: '01', heading: 'text-2xl sm:text-4xl', tone: 'paper' },
  { span: 'md:col-span-4', start: 'md:col-start-9', offset: 'md:mt-24', pad: 'p-6 sm:p-7', num: '02', heading: 'text-xl sm:text-2xl', tone: 'ink' },
  { span: 'md:col-span-3', start: 'md:col-start-1', offset: 'md:mt-20', pad: 'p-6', num: '03', heading: 'text-xl', tone: 'coral' },
  { span: 'md:col-span-5', start: 'md:col-start-4', offset: 'md:mt-36', pad: 'p-6 sm:p-8', num: '04', heading: 'text-2xl', tone: 'paper' },
  { span: 'md:col-span-4', start: 'md:col-start-9', offset: 'md:mt-10', pad: 'p-6 sm:p-8', num: '05', heading: 'text-2xl', tone: 'cobalt' },
  { span: 'md:col-span-6', start: 'md:col-start-1', offset: 'md:mt-16', pad: 'p-7 sm:p-10', num: '06', heading: 'text-2xl sm:text-3xl', tone: 'paper' },
  { span: 'md:col-span-5', start: 'md:col-start-8', offset: 'md:mt-8', pad: 'p-6 sm:p-9', num: '07', heading: 'text-2xl sm:text-3xl', tone: 'ink' },
]
    ...
    <section id="projects" className="section-rule mx-auto max-w-7xl px-5 py-20 sm:px-8 md:py-28">
      ...
      <div className="mt-20 grid gap-x-8 gap-y-14 md:grid-cols-12">
        {projects.map((project, i) => {
          ...
          return (
            <Reveal key={project.slug} delay={Math.min(i * 0.06, 0.25)} className={`${layout.span} ${layout.start} ${layout.offset}`}>
